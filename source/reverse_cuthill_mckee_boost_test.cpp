...
void reverse_cuthill_mckee_boost(const size_t &_size, const string &_file) {
    ...
    cout << "Reverse Cuthill-McKee Boost ordering:" << endl;
...
// -- UNCOMMENT IF BANDWIDTH OUTPUT IS NEEDED -- //
    ...
    cout << " >>> ExecutingTime: " << time << " sec" << endl << endl;
}
